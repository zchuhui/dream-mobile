...
import styles from "./friend-list.less";
    ...
    return (
      <div className={styles.chatWrap}> 
        <List >
          {
            list.map((item,index)=>(
              <Item className={styles.chatList} key={index} align="top" thumb={<img className={styles.headImg} src={item.img_url} />} multipleLine>
                {item.name}
              </Item>
            ))
          }
